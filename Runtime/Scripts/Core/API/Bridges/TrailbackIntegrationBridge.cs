...
namespace ModularForge.Trailback.Core
{
    ...
    public abstract class TrailbackIntegrationBridge
    {
        ...
        /// <summary>
        /// Initializes Trailback for a new navigation session.
        /// </summary>
        /// <remarks>
        /// Call this before registering any navigation elements. This ensures the
        /// framework starts from a clean state before the first screen or popup is shown.
        /// </remarks>
        public abstract void InitializeSession();
        
        /// <summary>
        /// Registers the back navigation handler used by Trailback to execute navigation.
        /// </summary>
        /// <param name="handler">
        /// Application-specific back navigation handler.
        /// </param>
        public abstract void SetNavigationHandler(IBackNavigationHandler handler);
        ...
        /// </summary>
        public abstract event Action OnNavigationRootReached;
